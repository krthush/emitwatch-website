            ...
            <div  class="col-md-5 d-none d-md-block">
                <div class="flex-center full-height full-width text-center">
                    <div class="titleFont">
                        ...
                        <div class="mx-auto" id='product-component-da66e42ecec'></div>
                    </div>
                </div>
            </div>
    ...
    (function () {
      ...
      function ShopifyBuyInit() {
        var client = ShopifyBuy.buildClient({
          domain: 'ownemit.myshopify.com',
          storefrontAccessToken: 'f87bf74acdc3f7b8a8de10399405ae0f',
        });

        ShopifyBuy.UI.onReady(client).then(function (ui) {
          ui.createComponent('product', {
            id: [1728003833902],
            node: document.getElementById('product-component-da66e42ecec'),
