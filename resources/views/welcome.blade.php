...
<div class="container-fluid zeroPad" id="fullpage">
    ...
    <div class="section">
        <div class="container-fluid">
            <div class="top-center-align titleFont titleSize blackText">PROGRESS</div>
            <div class="row full-width sectionContainer">
            ...
            <img src="/images/sideup_life_comp.png" id="bottomImage" class="img-fluid" alt="Responsive image">
        </div>
    </div>

    <div class="section">
        <div class="container-fluid">
            <div class="top-center-align titleFont titleSize blackText">MISSION</div>
            <div class="row full-width sectionContainer">
